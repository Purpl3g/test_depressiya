...
if 0 <= count <= 9:
    print (name + ", Ваш показатель - " + str(count) + ". У Вас отсутствуют депрессивные симптомы")
elif 10 <= count <= 15:
    print(name + ", Ваш показатель - " + str(count) + ". У Вас легкая депрессия (субдепрессия)")
elif 16 <= count <= 19:
    print(name + ", Ваш показатель - " + str(count) + ". У Вас умеренная депрессия")
elif 20 <= count <= 29:
    print(name + ", Ваш показатель - " + str(count) + ". У Вас выраженная депрессия (средней тяжести)")
elif 30 <= count <= 63:
    print(name + ", Ваш показатель - " + str(count) + ". У Вас тяжелая депрессия")
